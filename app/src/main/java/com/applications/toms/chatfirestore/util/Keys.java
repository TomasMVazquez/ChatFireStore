...
public class Keys {
    ...
    public static final String KEY_USERS_IMAGEURL = "imageURL";
    public static final String KEY_USERS_STATUS = "status";
    public static final String KEY_USERS_SEARCH = "search";
    public static final String KEY_USERS_TOKEN = "token";
